...
class Redis_client():
    ...
    def __init__(self, host='localhost', port=6379, password=''):
        # Set decode_responses=True to get bytes response,
...
if __name__ == '__main__':
    ...
    # print(fedscale_home)
    if not check_redis_server_online():
